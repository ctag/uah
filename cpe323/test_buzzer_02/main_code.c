 ...
 * 
 * Description:
 * This program will test the buzzer.
 *
...
void main(void)
{
	...
	TBCTL = 0x0110;
	// ACLK = 32,768Hz
	// We want something more like 10,000Hz, so divide ACLK to as close to 3 as possible?
	// Hence, IDx (input divider) is set to 2 (01), IDx=01;
	// MCx = 01, Up mode.
